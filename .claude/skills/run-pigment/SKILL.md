...
"Sober Runtime" card reading "Installed — 1.7.1 (build <date>)", and the "Make Pigment the
...
54 tests: 51 in `pigment-core` plus 3 in the GUI crate (`ui::settings`, which
checks the Sober config keys the page manages). Fast, no display needed.
